...
const LandingFooterComponent = () => {
  ...
  const serviceLinks = useMemo(
    () => ["Towing", "Tire Change", "Fuel Delivery", "Battery Jump", "Lockout"],
    [],
  );
        ...
        <Grid gutter={60}>
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Link href="/" className="flex items-center gap-3 mb-6">
              <div className="relative h-9 w-9 overflow-hidden rounded-lg shadow-lg shadow-red-500/10 bg-white p-1">
                <Image
